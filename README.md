...
`BA 量化/ai-quant-lab/indicator-studio/` 是一个静态量化研究工具，用于选择股票样例数据、导入 CSV、计算技术指标、调节参数、标注规则信号、运行策略回测、查看绩效指标、管理实验版本，并对比多只股票的区间表现。
...
当前支持 MA、EMA、BOLL、MACD、RSI、KDJ、ATR、成交量均线、信号视图、策略验证、参数扫描、模板市场、AI 解释、项目实验和配置保存。
